...
<head>
	...
	<title>SMK IMY</title>
	<link rel="icon" type="image/png" href="<?php echo media_url('img/farm.png') ?>">
...
<body>
	...
	<!-- Home -->
<body style="background-image:url(asset/images/icon/bg6.png);background-size:cover;">
		...
		<div class="container text-center">
			<div class="row">
				<div class="col-md-12">
					...
					<p class="lead mb-5 colr"><h1><strong>SMK INSAN MULIA YOGYAKARTA</strong></h1></p>
				</div>	
