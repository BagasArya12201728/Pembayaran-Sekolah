<section class="content">
  <div class="row"> 
    <div class="col-md-12">
      <div class="box box-info box-solid" style="border: 1px solid #4f207a !important;">
              ...
              <table class="table table-striped table-hover" style="cursor: pointer;">
                ...
                <tbody>
                  ...
                  foreach ($bulan as $row): 
                    ...
                    ?>
                  <tr style="color:<?php echo ($row['bulan_status'] == 1) ? '#4f207a' : 'red' ?>">              
                    <td><?php echo $i; ?></td>
              ...
              <tbody>
                ...
                foreach ($bebas as $row):
                  if (isset($f['n']) AND $f['r'] == $row['student_nis']) {
                    ...
                    $namePay = $row['pos_name'].' - T.A '.$row['period_start'].'/'.$row['period_end'];
                    ?>
                    <tr style="color:<?php echo ($row['bebas_bill'] == $row['bebas_total_pay']) ? '#4f207a' : 'red' ?>">
                      <td><?php echo $i ?></td>
                      <td><?php echo $namePay ?></td>
